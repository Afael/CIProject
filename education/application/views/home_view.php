        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="index.html">Trial Version</a>
                        <a href="#" class="x-navigation-control"></a>
                    </li>
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="<?php echo base_url();?>/assets/img/images/users/jajang.jpg" alt="John Doe"/>
                        </a>
                        <div class="profile">
                    ...
                    <!-- <?php echo $this->load->view('side_menu_view');?> -->
                      ...
                      <li class="xn-openable">
                          ...
                          <ul>
                              ...
                              <li><a href="#"><span class="fa fa-users"></span> Address Book</a></li>
                              <li class="xn-openable">
                              ...
                              <li><a href="#"><span class="fa fa-columns"></span> Content Table</a></li>
                              ...
                              <li class="xn-openable">
                                  ...
                                  <ul>
                                      <li><a href="#"><span class="fa fa-copy"></span> List of Posts</a></li>
                                      <li><a href="#"><span class="fa fa-file-o"></span>Single Post</a></li>
                                  </ul>
                              </li>
                              <li class="xn-openable">
                                  ...
                                  <ul>
                                      ...
                                      <li><a href="#"> Website Login Light</a></li>
                                  </ul>
                              </li>
                              <li class="xn-openable">
                                  <a href="#"><span class="fa fa-warning"></span> Error Pages</a>
                                  <ul>
                                      <li><a href="#">Error 404 Sample 1</a></li>
                                      <li><a href="#">Error 404 Sample 2</a></li>
                        ...
                        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
                            ...
                            <div class="panel-body list-group list-group-contacts scroll" style="height: 200px;">
                                <a href="#" class="list-group-item">
                                    ...
                                    <img src="<?php echo base_url();?>/assets/img/images/users/user2.jpg" class="pull-left" alt="John Doe"/>
                                    <span class="contacts-title">John Doe</span>
                                    <p>Praesent placerat tellus id augue condimentum</p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="list-group-status status-away"></div>
                                    <img src="<?php echo base_url();?>/assets/img/images/users/user.jpg" class="pull-left" alt="Dmitry Ivaniuk"/>
                                    <span class="contacts-title">Dmitry Ivaniuk</span>
                                    <p>Donec risus sapien, sagittis et magna quis</p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="list-group-status status-away"></div>
                                    <img src="<?php echo base_url();?>/assets/img/images/users/user3.jpg" class="pull-left" alt="Nadia Ali"/>
                                    <span class="contacts-title">Nadia Ali</span>
                                    <p>Mauris vel eros ut nunc rhoncus cursus sed</p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="list-group-status status-offline"></div>
                                    <img src="<?php echo base_url();?>/assets/img/images/users/user6.jpg" class="pull-left" alt="Darth Vader"/>
