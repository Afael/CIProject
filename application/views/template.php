            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        CLIP<i class="fa fa-paperclip"></i>ONE
                    </a>
                    <!-- end: LOGO -->
                </div>
                    ...
                    <ul class="nav navbar-right">
                        ...
                        <li class="dropdown current-user">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="pages_messages.html">
                                        <i class="fa fa-commenting-o" aria-hidden="true"></i> &nbsp;My Messages (3)
                                    </a>
                                </li>
                                <li class="divider"></li>
                                <li>
                        ...
                        <?php
                            ...
                            foreach ($main_menu as $main) {
                                ...
                                if($sub_menu->num_rows()>0){
                                    //Tampilkan Sub Menu di sini
                                    echo "<li>
                                          <a href='javascript:void(0)'>
                                          <i class='".$main->icon."'></i>
                                          <span class='title'> ".strtoupper($main->nama_menu)."</span><i class='fa fa-arrow-left'></i>
